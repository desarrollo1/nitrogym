...
class RootController(BaseController):
    """
    The root controller for the nitrogym application.
    ...
    @expose('nitrogym.templates.about')
    def about(self):
        """Handle the 'about' page."""
        return dict(page='about')

    @expose('nitrogym.templates.environ')
    def environ(self):
        """This method showcases TG's access to the wsgi environment."""
        return dict(environment=request.environ)

    @expose('nitrogym.templates.data')
    @expose('json')
    def data(self, **kw):
        """This method showcases how you can use the same controller for a data page and a display page"""
        return dict(params=kw)

    @expose('nitrogym.templates.authentication')
    def auth(self):
    ...
    @expose('nitrogym.templates.login')
